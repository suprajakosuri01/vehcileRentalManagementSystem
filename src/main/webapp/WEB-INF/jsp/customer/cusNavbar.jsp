...
<div style="background-color: teal;color:white;font-family: Helvetica, sans-serif;height:40px;line-height:2.5em">   
    <a style="color:white;text-decoration:none" href="cusHome.htm?usrEmail=${sessionScope.usrEmail}">Home</a> |
   	<a style="color:white;text-decoration:none" href="fetchVehicles.htm?usrEmail=${sessionScope.usrEmail}">Browse</a> | 
    <a style="color:white;text-decoration:none" href="orders.htm?usrEmail=${sessionScope.usrEmail}">My Books</a> | 
    <a style="color:white;text-decoration:none" href="bookedVehicles.htm?usrEmail=${sessionScope.usrEmail}">My Reservations</a>
